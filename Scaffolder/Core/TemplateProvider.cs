    ...
    public class TemplateProvider : ITemplateProvider
    {
        ...
        private static IEnumerable<dynamic> GetResources()
        {
            ...
            return new List<object>
            {
                ...
                new { RelativePath="DataAccess", FileName = "_ServiceName_SqlProvider.cs", ResourcePath = "DataAccess", overwrite = true },
                new { RelativePath="DataAccess", FileName = "I_ServiceName_Provider.cs", ResourcePath = "DataAccess", overwrite = true },
                new { RelativePath="DataAccess\\SqlScripts", FileName = "Create.Procedure._ServiceName_Delete.sql", ResourcePath = "DataAccess.SqlScripts", overwrite = true },
                new { RelativePath="DataAccess\\SqlScripts", FileName = "Create.Procedure._ServiceName_Get.sql", ResourcePath = "DataAccess.SqlScripts", overwrite = true },
                new { RelativePath="DataAccess\\SqlScripts", FileName = "Create.Procedure._ServiceName_Insert.sql", ResourcePath = "DataAccess.SqlScripts", overwrite = true },
                new { RelativePath="DataAccess\\SqlScripts", FileName = "Create.Procedure._ServiceName_Update.sql", ResourcePath = "DataAccess.SqlScripts", overwrite = true },
                new { RelativePath="DataAccess\\SqlScripts", FileName = "Create.Schema._TableSchema_.sql", ResourcePath = "DataAccess.SqlScripts", overwrite = true },
                new { RelativePath="DataAccess\\SqlScripts", FileName = "Create.Table._TableName_.sql", ResourcePath = "DataAccess.SqlScripts", overwrite = true },
                new { RelativePath="Models", FileName = "_ServiceModelName_.cs", ResourcePath = "Models", overwrite = true },
